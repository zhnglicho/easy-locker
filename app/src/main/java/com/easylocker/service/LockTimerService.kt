...
class LockTimerService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        reminderMinutes = intent?.getIntExtra(EXTRA_REMINDER_MINUTES, 1) ?: 1
    ...
    private fun acquireWakeLock() {
        ...
        ).apply { acquire(durationMinutes * 60_000L + 60_000L) }
    }
    ...
    companion object {
        ...
        private const val REMINDER_CHANNEL_ID = "lock_timer_reminder"
